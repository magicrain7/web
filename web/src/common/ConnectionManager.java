...
public class ConnectionManager {
	public static Connection getConnnect() {
		...
		try {
			...
			/*
			 * Class.forName("oracle.jdbc.OracleDriver"); String jdbc_url =
			...
			//datasource를 이용하여 connection 획득			
			  ...
			  DataSource ds = (DataSource)initContext.lookup("java:/comp/env/jdbc/oracle");  //connection pool, lookup:자원검색
